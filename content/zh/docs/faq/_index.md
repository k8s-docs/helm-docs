...
title: "常见问题"
weight: 8
aliases: ["/docs/topics/faq/", "/docs/faq/"]
description: "该页面提供帮助，最常见的问题。"
---

> 什么是 Helm2 和 Helm3 间的主要区别？

**我们很乐意帮助**你更好地使这个文件。 要添加，修改或删除信息，[文件中](https://github.com/helm/helm-www/issues)的问题或发送 pull 请求。
...
same namespace as the release itself. This means that users can now `helm install wordpress stable/wordpress` in two separate namespaces, and each can be
